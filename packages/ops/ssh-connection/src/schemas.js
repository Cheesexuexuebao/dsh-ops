/**
 * Zod schemas for the dsh-ssh-connection wire contract. Bundled into both faces:
...
export const setActiveResultSchema = resultSchema(
  z.object({ activeConnectionId: z.string() })
);
